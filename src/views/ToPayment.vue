  ...
  <section class="hero">
    ...
    <div class="mt-8 w-full max-w-md mx-auto bg-white rounded-lg p-4 md:p-6">
      ...
      <div class="mb-6">
        ...
        <div class="space-y-2">
          <label class="flex items-start gap-2 p-4 border rounded-lg hover:bg-gray-100 cursor-pointer">
            <input type="radio" name="delivery" value="sms" v-model="selectedDelivery" />
            <div class="flex-1 text-sm">
              <p class="font-medium">Mina sidor och SMS</p>
              <p class="text-gray-600">
                Gratis · Entrébiljetter och Ticket to Ride kommer som SMS och till Mina Sidor. Häften och presentkort hämtas i en
                kassa när du besöker parken.
              </p>
            </div>
          </label>
        </div>
          ...
          <div class="flex items-start gap-2">
            ...
            <div class="flex-1 text-sm">
              <p class="font-medium flex justify-between">
                Betala med Klarna <span class="bg-pink-200 text-black px-2 py-1 rounded">Klarna</span>
              </p>
